          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-left">
                  <a href="<?php echo $basead; ?>setting" class="btn btn-default btn-flat"><i class="glyphicon glyphicon-cog"></i> akun</a>
                </div>
              </li>
            </ul>
          </li>
...
if(empty($_GET['smkakh'])){
  ...
  else if($act=='siswa' or $act=='addsiswa' or $act=='editsiswa' or $act=='upload-siswa'){
...
<?php
  if(empty($_GET['smkakh'])){require 'view/home.php';}
    ...
    else if($act=='upload-siswa'){
      require 'view/upload-siswa.php';
    }
    else if($act=='setting'){
