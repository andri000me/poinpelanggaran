...
//siswa
  ...
  function kosongsiswa($con){
    $akh=mysqli_query($con,"DELETE from pelanggaran");
    $akh2=mysqli_query($con,"DELETE from orangtua");
    $akh3=mysqli_query($con,"DELETE from siswa");
    session_start();
    $_SESSION['pesan']='hapus';
    header('location:../../siswa');
  }
...
//pelanggaran
  ...
  function updatepassword($con,$nama,$username,$password){
    $akh=mysqli_query($con,"UPDATE admin set nama='$nama',username='$username',password='$password'");
    session_start();
