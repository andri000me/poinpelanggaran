      ...
      <div class="row">
        ...
        <?php $_SESSION['pesan'] = '';?>
          <div class="box box-info">
            ...
            <?php }else{?>
              <h3 class="box-title"></span>&nbsp;Seluruh Siswa</h3> <span style="float:right;"><a href="<?php echo $basead; ?>upload-siswa" class="btn btn-circle btn-primary"><i class="glyphicon glyphicon-upload"></i> Upload Siswa</a>
              | <a class="btn bg-red btn-sm" data-target="#hapus" href="" data-toggle="modal"><i class="glyphicon glyphicon-remove"></i> Hapus</a></span>
            <?php } ?>
            </div>
            <!-- /.box-header -->
...
<div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h4 class="modal-title" id="myModalLabel">Konfirmasi <b>Hapus Semua</b> Data Siswa, akan berpengaruh pada data pelanggaran dan data orang tua</h4>
        </div>
        <div class="modal-footer">
          <a href="<?php echo $basead; ?>a-control/<?php echo md5('kosongsiswa'); ?>/access" class="btn btn-primary btn-circle"><i class="glyphicon glyphicon-ok"></i> Lanjutkan</a> 
